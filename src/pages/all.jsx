            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col">
                        ...
                        <p>
                            &quot;Jenkins Is The Way&quot; is a global showcase
                            of how developers and engineers are building,
                            deploying, and automating great stuff with Jenkins.
                        </p>
                        <p>
                            Share your story and we'll send you a free Jenkins
                            Is The Way T-shirt.
                        </p>
                        <p>
                            <a href="/admin/#/collections/user-story">
                                Share the story
                            </a>{' '}
                            of your project's goals, technical challenges, and
                            the unique solutions you encountered with Jenkins.
                        </p>
                    </div>
                </div>
                <div className="row">
