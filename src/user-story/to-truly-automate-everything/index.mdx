...
quotes:
  - from: V Roshan Kumar Patro, Trainee, Linux World
    content: >-
      "Jenkins helped in achieving my automation work of continuously tweaking
      the Ml model until it reaches 90% accuracy through scripts."
