...
quotes:
  - from: Ganesh Mulik, Software Developer, TCS
    content: >-
      "Because of Jenkins, developers can now focus on the goal of the project —
      such as  developing the features for our customer — and worry less about
      the build and release processes and issues that come with it."
