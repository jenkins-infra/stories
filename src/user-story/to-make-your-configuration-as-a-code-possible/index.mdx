...
quotes:
  - from: Amet Umerov, DevOps Engineer, Preply
    content: >-
      "Jenkins made our development easier. Every engineer could make any
...
[Get more details on Preply’s use of Jenkins by reading the case study](https://jenkinsistheway.io/case-studies/jenkins-case-study-preply/). &gt;&gt;
