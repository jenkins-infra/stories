...
image: ./noun_Computer-Cloud_346045.png
industries:
...
quotes:
  - from: Erana Chandran, DevOps Engineer in Information Technology
    content: >-
      "With Jenkins, I am able to implement reliable multiple deployments in a
...
1.  Always maintain code synchronization between two different Git-repository managers.

2.  Track code changes in VCS

3.  Build and maintain artifacts, Deploythem in multiple environments

4.  Execute scripts for configuration management, production validation, and code quality

5.  Trigger the Jenkins deployment based on Gerrit and Bitbucket actions
