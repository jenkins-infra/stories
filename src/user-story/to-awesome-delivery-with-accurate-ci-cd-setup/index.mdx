...
quotes:
  - from: Ashish Kumar Das, Senior Software Specialist, Telstra Corporation
    content: >-
      "All the features of Jenkins — including Plugins setup, centralize UI
      dashboard to monitor jobs, and an easy way of creating jobs through the
      dashboard — makes it the Number One CI/CD tool in the industry."
    image: ashiish.jpeg
location: India
...
Our project can be seen at <a href="https://www.businessdirect.att.com/portal/index.jsp" class="bare">https://www.businessdirect.att.com/portal/index.jsp</a>.
