...
image: ./noun_Computer-page-proofs_532092.png
industries:
  - Software
...
quotes:
  - from: Nachiket Kulkarni, DevOps Engineer, NICE Actimize
    content: >-
      "Jenkins reduced the time required from build development to testing to
      delivery. It allowed for an automated approach to result reporting and
      reduced the need for costly infrastructure required for testing.“
    image: nachilket.jpeg
---
...
1.  Leveraged the Jenkins EC2 plugin and created AMIs of the required platforms using AWS and configured them on Jenkins.

2.  Parallel launched EC2 nodes for each OS platform and ran Java, Ant, and Maven-based unit and automation tests across all platforms.

3.  These nodes were dynamic, hence destroyed after use. This presented an opportunity to save costs.

4.  Leveraged the Jenkins Docker plugin and Docker on nodes to run pipelines in a clean dockerized environment. Stability tests lasting up to 72 hours were also run.

5.  Published all test results via Jenkins to Grafana and our in-house analytics tool for visualization.
