...
tag_line: >-
  ...
  projects.
image: ./elastic-search-300x300.png
...
quotes:
  - from: Ivan Fernandez, Software Engineer
    content: >-
      "Jenkins rocks because now we just build and test it. No hands! Simply
      push to GitHub and everything is magic.“
    image: Ivan-Fernandez.png
location: Spain
name: Ivan Fernandez
latitude: '37.2596578'
...
**"Jenkins rocks because now we just build and test it. No hands! Simply push to GitHub and everything is magic."** <img src="./Ivan-Fernandez.png" width="218" height="223" alt="Ivan Fernandez" /> Ivan Fernandez, Software Engineer
