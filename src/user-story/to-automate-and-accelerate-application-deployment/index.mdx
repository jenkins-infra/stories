...
image: ./noun_Computer_3767284.png
industries:
...
quotes:
  - from: Mary Jane Buenaventura, Solution Architect
    content: >-
      "Jenkins eased the build and deployment process of our project. The
      current Jenkins solution feature we used is the easiest configuration and
      it surely served the purpose."
