...
quotes:
  - from: Saikat Das, Senior DevOps Engineer, IBM
    content: >-
      "Jenkins helped us to reach our goal to save unnecessary costs for the
      enterprise by automating CI/CD, test and backup jobs. We were able to
      schedule IT using Cron job, as well as completing all work before it was
      due. This allowed IT to get back to personal lives instead of overworking,
      and make life easier for all during the COVID pandemic."
