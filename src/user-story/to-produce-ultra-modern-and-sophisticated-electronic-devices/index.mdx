...
image: ./Screen-Shot-2021-04-14-at-10.35.50-AM.png
...
quotes:
  - from: Ankit Menon, Senior DevOps Engineer, Apple
    content: >-
      "Jenkins speeds up the process of development which makes the software run
      better with the hardware. It’s the secret of successful rollouts by giving
      us the ability to run extensive automated tests."
    image: ankit.jpeg
location: India
name: Ankit Menon
latitude: '12.9715987'
