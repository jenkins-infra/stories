...
quotes:
  - from: Debobrata Bose, Developer
    content: >-
      "Jenkins is a very popular Java-based, open-source, continuous integration
      (CI) server that allows teams to continuously build applications across
      platforms."
    image: 1517691620855.jpeg
location: India
name: Debobrata Bose
latitude: '13.0218597'
