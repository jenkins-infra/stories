...
quotes:
  - from: Ioannis Moutsatsos, AD & Senior Principal, Data Science, Novartis
    content: >-
      "When I demonstrated 'Jenkins for Life Science Continuous Integration' a
      few years ago, Koshuke commented that this is a totally different domain
      application for Jenkins. Indeed true, yet built on the same foundational
      work of the Jenkins Community and The Plugin Contributors! Let's start
      thinking Jenkins is the Way to 'Think Outside the Box'."
    image: ioannis.jpeg
