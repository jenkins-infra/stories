...
quotes:
  - from: Ahmed AbouZaid, DevOps Engineer, Camunda
    content: >-
      "What helped us a lot is Jenkins' extensibility, using Jenkins plugins and
      shared libraries; Jenkins is more like a framework to develop CI/CD that
...
-   [Jenkins Job DSL](https://plugins.jenkins.io/job-dsl/) is so powerful, however it’s first release was in 2012! So it’s a bit old now and hard to learn by every developer
...
-   Moved to [Jenkins Declarative Pipelines](https://www.jenkins.io/doc/book/pipeline/syntax/), which has a more standard and straightforward syntax
...
<a href="https://github.com/camunda/camunda-bpm-platform/blob/master/Jenkinsfile" class="bare">https://github.com/camunda/camunda-bpm-platform/blob/master/Jenkinsfile</a>
