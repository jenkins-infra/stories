...
<img src="./avoris-banner-768x211.png" width="768" height="211" alt="image" />
...
<img src="./Grafico_pegado-3-1024x544.png" width="1024" height="544" alt="image" />

Process improvement is top of mind for the ops team at Avoris. And Alejandro shared [his story](https://jenkinsistheway.io/user-story/to-do-things-quickly-simply-and-in-a-powerful-way/) for one critical instance where the use of Jenkins made a big difference. They realized their build times were on the decline, so they sought to minimize their delivery cycle times with Jenkins. The results? The team was able to speed up their CI/CD with shared volumes and more. And they were able to reduce build times more than 50%.
