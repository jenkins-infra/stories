...
quotes:
  - from: Alexander Leibzon, Software Developer/Architect
    content: >-
      "The key difference is the huge community, and the fact that Jenkins is a
      true ‘battle-proven’ tool.“
    image: Alex-L.jpeg
location: Israel
industries:
...
**"The key difference is the huge community, and the fact that Jenkins is a true 'battle-proven' tool."** <img src="./Alex-L.jpeg" width="450" height="450" alt="Alex L" /> Alexander Leibzon, Software Developer/Architect
...
After figuring out the need for a [Jenkins PagerDuty plugin](https://plugins.jenkins.io/pagerduty/), it was an easy choice to turn to Jenkins documentation and codebase. This is actually a really awesome way to get to know Jenkins in-depth, much more than just using it to execute pipelines or run ad hoc jobs. After going over possible plugin options, PagerDuty was created as a post-build notifier plugin. \*\*
