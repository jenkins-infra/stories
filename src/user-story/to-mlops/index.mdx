...
quotes:
  - from: Liwei Yang, Director, Athemaster
    content: '"Jenkins makes complex data pipeline management become simple."'
...
2.  Observability and transparency. Jenkins' UI is very simple. I can see the status of a job easily and clearly. I can even customize the sheet to filter and organize different types of jobs. If something goes wrong, I can follow the UI by clicking the red light, and find the log of the red stage.

3.  Extendibility. Jenkins has a powerful plugin system. It makes Jenkins stronger and with that, there are more possibilities. I can always find features I want in the plugins market.

Speaking of capabilities:

1.  UI Design. Jenkins UI is very, very, very simple, clear, and easy to use and understand.

2.  Run condition and conditional build. Data Pipelines are very complex. According to the result, I have to choose different build stages.

3.  Parameterized Scheduler and parameterized trigger. Rerun a data pipeline is very common. Parameterized trigger lets me easily rerun a pipeline with a customized parameter.
