...
<img src="./tymitcc.png" width="287" height="176" alt="image" />
...
<img src="./cc-image-768x344.png" width="768" height="344" alt="image" />
...
And as Francisco shared in his [Jenkins User Story](https://jenkinsistheway.io/user-story/to-scale-from-the-ground-up/): "Jenkins has all of the key ingredients required to be successful: power, flexibility, scalability and community." It would seem that the same description applies to the innovative credit card apps powered by Tymit.
