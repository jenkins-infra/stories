...
<img src="./preply.png" width="297" height="297" alt="image" />
...
"In our company, we are trying to use an '[Everything as a Code](https://hackernoon.com/everything-as-code-explained-0ibg32a3)' paradigm which is about having reproducible infrastructure, monitoring, jobs, credentials, jobs, and many other things in code," Amet said. "Using Jenkins allows us to configure fully reproducible code and fuel a completely automated CI/CD process for all projects inside our company."

Preply’s team initially [tried running Jenkins in Kubernetes](https://medium.com/preply-engineering/jenkins-omg-275e2df5d647). However, it wasn’t as compatible, nor did it completely address their specific requirements. To automate their platform, they needed to begin by building a more robust underlying infrastructure for Jenkins, and include Jenkins in more aspects, like configuration, jobs, and plugins.

*Diagram of the new Preply’s Jenkins architecture*

<img src="./pasted-image-0-300x171.png" width="300" height="171" alt="image" />
...
And while setting up a reproducible Jenkins configuration process was paramount in building their CI/CD, creating the job configuration was equally essential. As we mentioned earlier, we’re talking about managing a few dozens of releases per day. [Jenkins Job Builder](https://opendev.org/jjb/jenkins-job-builder) (JJB) and [Job DSL](https://github.com/jenkinsci/job-dsl-plugin) plugins meet the need for the team to manage freestyle projects either using GUI or directly using the REST API.
...
**Want to get the tech specifics, read** [**Preply’s Engineering Blog on Medium**](https://medium.com/preply-engineering/jenkins-omg-275e2df5d647) or visit Amet’s \* <a href="https://jenkinsistheway.io/user-story/jenkins-is-the-way-to-make-your-configuration-as-a-code-possible/" class="bare">https://jenkinsistheway.io/user-story/jenkins-is-the-way-to-make-your-configuration-as-a-code-possible/</a>**.**
