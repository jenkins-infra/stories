...
image: ./Screen-Shot-2021-12-06-at-10.40.46-AM.png
...
quotes:
  - from: Felipe Martinelli, Manager, goFlux
    content: >-
      "Jenkins made it possible to streamline the pipelines using Groovy to
      compile different projects according to the language used. Integrations
      with other solutions, repositories and cloud services make the result more
