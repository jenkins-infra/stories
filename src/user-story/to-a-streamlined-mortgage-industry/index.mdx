...
quotes:
  - from: Arman Chand, Software Engineer
    content: >-
      "Our project uses Jenkins pipelines for each of their builds and relies on
      the flexibility and countless plugin features to continually improve their
      processes."
