...
quotes:
  - from: Jorge Uztariz, Devops Lead, Consis Internacional
    content: >-
      "Jenkins made everything easier and faster. It gave me the free time to
...
-   For telegram notifications we use plugin "Build Notifications" at <a href="https://plugins.jenkins.io/build-notifications" class="bare">https://plugins.jenkins.io/build-notifications</a>

-   For email notifications we use plugin "Mailer" at <a href="https://plugins.jenkins.io/mailer" class="bare">https://plugins.jenkins.io/mailer</a>

-   For the bitbucket oauth integration we use plugin "Bitbucket OAuth"  at <a href="https://plugins.jenkins.io/bitbucket-oauth" class="bare">https://plugins.jenkins.io/bitbucket-oauth</a>

-   For the trigger variable we use plugin "Parameterized Trigger" at <a href="https://plugins.jenkins.io/parameterized-trigger" class="bare">https://plugins.jenkins.io/parameterized-trigger</a>

-   For the bitbucket integration we use plugin "Bitbucket" at <a href="https://plugins.jenkins.io/bitbucket/" class="bare">https://plugins.jenkins.io/bitbucket/</a>
