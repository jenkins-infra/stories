...
quotes:
  - from: Donald Morton, Build and Release Manager, Graylog
    content: >-
      "Jenkins' flexibility is its real power. When you have complex needs like
      we do, you need something that can handle anything you can throw at it."
    image: donald-morton.jpeg
...
***Want the full story, visit Donald Morton’s [Graylog Case Study](https://jenkinsistheway.io/case-studies/jenkins-case-study-graylog/).***
