...
tag_line: >-
  ...
  process.
image: ./noun_investor_2260361.png
...
quotes:
  - from: Ethan Collopy, Lead Developer
    content: >-
      "Jenkins improved all aspects of the release cycle. No longer do we have
      to use different internal tools for building and releasing to development
