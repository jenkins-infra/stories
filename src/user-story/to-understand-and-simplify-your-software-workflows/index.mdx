...
quotes:
  - from: Koen Poppe, Project Engineer / Software
    content: >-
      "Jenkins deals with all the repetitive things that would only distract
      developers from the real work."
