...
image: ./noun_Computer-Time_3616096.png
industries:
...
quotes:
  - from: Daniel Steiert, Senior DevOps Engineer SAP Hybris
    content: '"Jenkins is the way to make no-code pipelines possible."'
