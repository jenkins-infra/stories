...
quotes:
  - from: Alejandro Alvarez Vazquez, Sysadmin, Avoris Travel
    content: >-
      "Jenkins rocks because of the huge number of integration possibilities and
      plugins available, as well as the huge community and resources available.“
...
**Solution & Results: **To solve the continuous and repetitive download of maven dependencies, we decided to use the mounted volumes offered by the Kubernetes plugin, mapping the agent’s directory (/var/jenkins\_home/.m2) to a shared directory on the Kubernetes nodes (/mnt/home-jenkins-m2). This allows all builds to share the same .m2.
...
<img src="./code-768x785.png" width="768" height="785" alt="image" />
