...
quotes:
  - from: John Crafton, Sr. Software Architect
    content: >-
      "Without Jenkins, I could have probably made due with `bash` and `cron` in
      the background of things. But with Jenkins, everything was faster and
      better than that ever could've been."
