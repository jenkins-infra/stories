...
tag_line: >-
  ...
  company.
image: ./noun_visible_1551071.png
industries:
...
quotes:
  - from: Vijay Sundar V Technical Specialist, DevOps
    content: >-
      "Jenkins is a very popular Java-based, open-source, CI server that allows
      teams to continuously build applications across platforms.
