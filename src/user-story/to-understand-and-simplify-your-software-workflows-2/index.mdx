...
quotes:
  - from: Javier Méndez Veira, Tech Lead, Netex Learning
    content: '"Thanks to Jenkins, I’ve automated many workflows and saved so much time."'
