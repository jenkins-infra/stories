...
quotes:
  - from: Githin Joseph, Jenkins User
    content: >-
      "Jenkins transformed our build and deployment process from a mountain of
      activities to a single click.“
