...
image: ./noun_online-shopping_1845728-300x300.png
organization: >-
...
quotes:
  - from: Leandro Martins, DevOps Engineer
    content: >-
      "Jenkins rocks because it is a customizable robust solution that helped us
      reduce pipeline time by 50% – including deployment – and resource costs by
      40%." 
    image: leandrocostam_photo.jpeg
location: Germany
...
**"Jenkins rocks because it is a customizable robust solution that helped us reduce pipeline time by 50% – including deployment – and resource costs by 40%."** <img src="./leandrocostam_photo.jpeg" width="576" height="768" alt="leandrocostam_photo" /> Leandro Martins, DevOps Engineer
