...
quotes:
  - from: Bhargav Murarisetty, Sr.Automation Test Engineer, Amdocs
    content: >-
      "Jenkins made a difference by easing testers' lives with jobs, schedulers
      and pipelines. It decreased the dependency of knowledge for new joiners in
      the testing team to run sanity or any automation test cases/scripts."
