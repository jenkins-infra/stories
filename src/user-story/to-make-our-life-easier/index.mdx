...
quotes:
  - from: Oleh Moskovych, Systems Engineer
    content: >-
      "Jenkins is simple, reliable and — at the same time — complex. It’s a very
      flexible tool with the power to integrate with whatever you need. It's the
...
1.  Significantly extend the functionality of pipelines by creating our own modules
