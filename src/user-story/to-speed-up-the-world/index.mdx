...
tag_line: >-
  ...
  Argentinian bank.
image: ./noun_bank-to-bank_3412465.png
industries:
  - Financial Services
...
quotes:
  - from: Pablo Del Giudice, Tech Director
    content: >-
      "Jenkins provided the cost-effective tools we needed to allow us to
      implement DevOps in an easy, fast way. Doing so enables us to increase
      business value."
