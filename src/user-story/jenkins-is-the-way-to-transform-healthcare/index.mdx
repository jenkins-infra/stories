...
tag_line: >-
  ...
  of a global firm.
image: ./noun_diagnosis_2592165.png
industries:
  - Healthcare
...
quotes:
  - from: Ashutosh Pattanaik, Build & Release Engineer
    content: >-
      "Jenkins is the way to easily manage all the code from end-to-end, from
      commits till deployment. The enormous number of plugins help you do almost
      anything."
