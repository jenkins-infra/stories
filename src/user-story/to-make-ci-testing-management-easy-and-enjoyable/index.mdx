...
image: ./issoft_logo_dark-blue@1x.png
...
quotes:
  - from: Konstantin Starovoytov, QA Automation, ISsoft
    content: >-
      "Jenkins gave our manual QA team the possibility to use and run automation
      tests on their own, avoiding errors while decreasing the time it takes to
      execute testing."
